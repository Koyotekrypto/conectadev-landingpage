                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    <div className="col-span-1 lg:col-span-2">
                        ...
                        <div className="flex gap-4">
                            <a
                                className="group w-11 h-11 rounded-full bg-gray-200 dark:bg-white/5 flex items-center justify-center hover:bg-white transition-all duration-300 border border-transparent hover:border-[#1877F2]/20"
                                href="https://www.facebook.com/people/ConectaDev"
                                target="_blank"
                                rel="noopener noreferrer"
                                title="Facebook"
                            >
                                <Facebook className="w-5 h-5 text-gray-600 dark:text-white/70 group-hover:text-[#1877F2] transition-all duration-300" />
                            </a>
                            <a
                                className="group w-11 h-11 rounded-full bg-gray-200 dark:bg-white/5 flex items-center justify-center hover:bg-white transition-all duration-300 border border-transparent hover:border-[#ee2a7b]/20"
                                href="https://www.instagram.com/conectadev.br/"
                                target="_blank"
                                rel="noopener noreferrer"
                                title="Instagram"
                            >
                                <Instagram className="w-5 h-5 text-gray-600 dark:text-white/70 group-hover:text-[#ee2a7b] transition-all duration-300" />
                            </a>
                            <a
                                className="group w-11 h-11 rounded-full bg-gray-200 dark:bg-white/5 flex items-center justify-center hover:bg-white transition-all duration-300 border border-transparent hover:border-[#25D366]/20"
                            ...
                            >
                                <svg
                                    viewBox="0 0 24 24"
                                    className="w-5 h-5 fill-gray-600 dark:fill-white/70 group-hover:fill-[#25D366] transition-all duration-300"
                            ...
                            <a
                                className="group w-11 h-11 rounded-full bg-gray-200 dark:bg-white/5 flex items-center justify-center hover:bg-white transition-all duration-300 border border-transparent hover:border-[#0A66C2]/20"
                                href="https://www.linkedin.com/company/conectadev"
                                target="_blank"
                                rel="noopener noreferrer"
                                title="LinkedIn"
                            >
                                <Linkedin className="w-5 h-5 text-gray-600 dark:text-white/70 group-hover:text-[#0A66C2] transition-all duration-300" />
                            </a>
                        </div>
                    </div>
                    <div>
