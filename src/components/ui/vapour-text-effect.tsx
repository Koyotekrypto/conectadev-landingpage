...
export default function VaporizeTextCycle({
    ...
    color = "rgb(206, 240, 46)", // Default ConectaDEV #CEF02E
    spread = 5,
    density = 5,
    animation = {
        vaporizeDuration: 2,
    ...
    particles.forEach(particle => {
        ...
        if (shouldVaporize) {
            ...
            if (particle.shouldFadeQuickly) {
                ...
                // Much more persistence: minimum 50% opacity during vaporization
                particle.opacity = Math.max(0.5, particle.opacity - deltaTime * durationBasedFadeRate);
            }

            // A particle is considered "done" only if reached 0.5 opacity (no longer disappearing)
